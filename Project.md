...
- In progress (M7, M8, M9, M10, M11, M12, M13, M14, M15, M16, M17.0, M17.1, M17.2, M17.3, M17.4, M17.5, M17.6, M17.7.1, M17.7.2, M18.1, and the module-boundary diagnostics v1 baseline completed and accepted; the M20 Harness foundation is implemented, while M20 human acceptance is reopened for the canonical `notification.show` payload migration and terminal/Android revalidation; broader M17 real multi-edge interaction expansion continues; M17.8 remains the dedicated mobile sensitive-screen capture governance milestone; broader M18 observation understanding may build on the Harness foundation, while M19 bounded-growth/storage-hygiene hardening remains paused until broader M18 is accepted; M20.1 governed skill drafts, M21 policy learning/review, M22 productization, and M23 ecosystem bridging remain deferred)
...
- We completed the M20 Harness foundation after a configured-provider Gateway/terminal human-acceptance ladder proved the governed outer action loop, real public fetch/search, research-assisted reply, hostile fixture provenance with no action or memory side effect, and fresh-session Hermes native-memory recall with body-free evidence. A later natural terminal greeting reopened M20 human acceptance because Hermes emitted `{title, body}` while the legacy notification action contract required `{message}`; the chosen repair is one canonical `notification.show {title?, body}` contract across notification-capable edges, followed by fresh terminal and Android validation. M20.1 remains the owner of governed procedural-memory and skill lifecycle work, and M19 follows broader M18 before M21 policy learning, M22 product packaging, and M23 ecosystem bridging
