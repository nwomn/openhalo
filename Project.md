...
- In progress (M7, M8, M9, M10, M11, M12, M13, M14, M15, M16, M17.0, M17.1, M17.2, M17.3, M17.4, M17.5, M17.6, M17.7.1, M17.7.2, M18.1, the module-boundary diagnostics v1 baseline, and M20 completed and accepted; M20 acceptance includes configured-provider Terminal and Android cross-edge human verification of the canonical `notification.show` contract and requester outcomes; broader M17 real multi-edge interaction expansion continues; M17.8 remains the dedicated mobile sensitive-screen capture governance milestone; broader M18 observation understanding may now build on the accepted Harness foundation, while M19 bounded-growth/storage-hygiene hardening remains paused until broader M18 is accepted; M20.1 governed skill drafts, M21 policy learning/review, M22 productization, and M23 ecosystem bridging remain deferred)
...
- M20 is accepted complete after the fresh configured-provider Android human run on 2026-07-17. The persisted acceptance state contains 4 completed explicit-user interactions, 7 successful edge action results, 11 allowed Presence decisions, exact roster/capability records for the connected Terminal and Android edges, and verified requester outcome updates in both directions. The residual Hermes stdout progress indicator is operational-log presentation noise, not an M20 acceptance blocker.
