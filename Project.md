...
- In progress (M7, M8, M9, M10, M11, M12, M13, M14, M15, M16, M17.0, M17.1, M17.2, M17.3, M17.4, M17.5, M17.6, M17.7.1, M17.7.2, M18.1, and the module-boundary diagnostics v1 baseline completed and accepted; the M20 Harness foundation and fresh Terminal Edge human revalidation are complete, while Android still requires the canonical `notification.show` payload migration and local human acceptance; broader M17 real multi-edge interaction expansion continues; M17.8 remains the dedicated mobile sensitive-screen capture governance milestone; broader M18 observation understanding may build on the Harness foundation, while M19 bounded-growth/storage-hygiene hardening remains paused until broader M18 is accepted; M20.1 governed skill drafts, M21 policy learning/review, M22 productization, and M23 ecosystem bridging remain deferred)
