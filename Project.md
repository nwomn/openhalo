...
- In progress (`M7`, `M8`, `M9`, `M10`, `M11`, `M12`, `M13`, `M14`, `M15`, `M16`, `M17.0`, `M17.1`, `M17.2`, `M17.3`, `M17.4`, `M17.5`, `M17.6`, and the module-boundary diagnostics v1 baseline completed and accepted; broader `M17` real multi-edge interaction expansion continues on top of the accepted Android phone edge product UI, screen-observation, and multi-edge lineage/fail-fast semantics baselines; `M17.7.1` is now the next active M17 milestone for Android Edge continuous background observation steady state, followed by `M17.7.2` Runtime mobile observation liveness watchdog and wake recovery; `M17.8` is now defined as the dedicated mobile sensitive-screen capture governance milestone split out from M17.5 after live banking-screen testing showed best-effort detection is not a sufficient privacy boundary; `M18` observation-driven idle intent sensing and `M19` action/tool governance remain later work; `M20` policy learning/review is intentionally deferred until the system is stable but not fully ergonomic; `M21` first packaged three-end product slice is now the first concrete milestone for productization; storage hardening is deferred to `M22`; Home Assistant Bridge Edge and broader smart-home ecosystem bridging are intentionally deferred to `M23`)
