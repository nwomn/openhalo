...
- In progress (`M7`, `M8`, `M9`, `M10`, `M11`, `M12`, `M13`, `M14`, `M15`, `M16`, `M17.0`, `M17.1`, `M17.2`, `M17.3`, `M17.4`, `M17.5`, `M17.6`, `M17.7.1`, `M17.7.2`, `M18.1`, and the module-boundary diagnostics v1 baseline completed and accepted; broader `M17` real multi-edge interaction expansion continues on top of the accepted Android phone edge product UI, screen-observation, multi-edge lineage/fail-fast semantics, half-hour-class Android background observation steady-state, runtime-managed mobile liveness/reconnect-recovery baselines, and accepted observation-to-snapshot decision-space integration; `M17.8` remains the dedicated mobile sensitive-screen capture governance milestone split out from M17.5 after live banking-screen testing showed best-effort detection is not a sufficient privacy boundary; broader `M18` observation-driven idle intent sensing remains later work; `M19` bounded-growth/storage-hygiene hardening is now the first post-M18 hardening milestone; `M20` Agent Harness and runtime action-loop architecture refactor now absorbs unified action/tool governance; `M21` policy learning/review is intentionally deferred until after the harness refactor; `M22` first packaged three-end product slice is now the concrete productization milestone near the end of the current roadmap; Home Assistant Bridge Edge and broader smart-home ecosystem bridging remain the final currently tracked milestone at `M23`)
