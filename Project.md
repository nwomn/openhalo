...
- 4.20. Define milestone M19: bounded-growth and storage-hygiene hardening after observation-driven intent sensing, covering unbounded state growth, high-frequency persistence pressure, duplicated long-term storage, and other operational accumulation risks before the later harness refactor and product packaging work build on larger runtime histories
- 4.21. Define milestone M20: Agent Harness and runtime action-loop architecture refactor with unified action/tool governance, so the already-running OpenHalo system can be reshaped around a Hermes-backed harness core, nested internal agent loop, external runtime action loop, memory-consolidation model, LLMOps/eval gate, and one inspectable runtime contract for model-native tool calls, MCP/tool/skill calls, runtime-local tools, and external device actions
...
- The harness implementation may be Hermes-backed as the preferred first spike, but any reused Hermes capability must still obey OpenHalo's action-governance boundaries, especially the split between agent-private tools and runtime-governed actions
...
- In progress (`M7`, `M8`, `M9`, `M10`, `M11`, `M12`, `M13`, `M14`, `M15`, `M16`, `M17.0`, `M17.1`, `M17.2`, `M17.3`, `M17.4`, `M17.5`, `M17.6`, `M17.7.1`, `M17.7.2`, and the module-boundary diagnostics v1 baseline completed and accepted; broader `M17` real multi-edge interaction expansion continues on top of the accepted Android phone edge product UI, screen-observation, multi-edge lineage/fail-fast semantics, half-hour-class Android background observation steady-state, and runtime-managed mobile liveness/reconnect-recovery baselines; `M17.8` is now defined as the dedicated mobile sensitive-screen capture governance milestone split out from M17.5 after live banking-screen testing showed best-effort detection is not a sufficient privacy boundary; `M18` observation-driven idle intent sensing remains later work; `M19` bounded-growth/storage-hygiene hardening is now the first post-M18 hardening milestone; `M20` Agent Harness and runtime action-loop architecture refactor now absorbs unified action/tool governance; `M21` policy learning/review is intentionally deferred until after the harness refactor; `M22` first packaged three-end product slice is now the concrete productization milestone near the end of the current roadmap; Home Assistant Bridge Edge and broader smart-home ecosystem bridging remain the final currently tracked milestone at `M23`)
...
- Prefer the next post-M7 milestone sequence to stay narrow and layered: M8 formal terminal edge first, M9 cloud-model agent baseline second, M10 grounding and memory third, M11 terminal/CLI interaction maturity fourth, M12 prompt/context engineering fifth, M13 proposal-formation maturity sixth, M14 model-provider connection reliability and diagnostics seventh, M15 runtime-native credential/runtime-config baseline eighth, M16 post-action deliberation/action loop ninth, M17 multi-edge interaction expansion tenth, M18 observation-driven idle intent sensing eleventh, M19 bounded-growth/storage-hygiene hardening twelfth, M20 Agent Harness and runtime action-loop architecture refactor with unified action/tool governance thirteenth, M21 policy learning/review fourteenth, M22 first packaged three-end product slice fifteenth, and M23 Home Assistant / smart-home ecosystem bridge last
...
- Post-M16 architecture expansion has completed and accepted `M17.0` public Edge API boundary/internal-runtime encapsulation, `M17.1` registration-driven multi-device extension, `M17.2` native Android Presence Edge, `M17.3` Android daily-use hardening, `M17.4` Mobile Edge product UI implementation, `M17.5` Android screen/context observation baseline, `M17.6` multi-edge lineage/fail-fast semantics, `M17.7.1` Android Edge continuous background observation steady state, `M17.7.2` Runtime mobile observation liveness watchdog and wake recovery, and the module-boundary diagnostics v1 baseline. The next M17 milestone is `M17.8` mobile sensitive-screen capture governance, followed by `M18.1` observation-to-snapshot decision-space integration and broader `M18` observation-driven idle intent sensing; after M18, the roadmap now runs through `M19` bounded-growth/storage-hygiene hardening, `M20` Agent Harness and runtime action-loop architecture refactor with unified action/tool governance, `M21` policy learning/review, `M22` first packaged three-end productization, and final tracked `M23` Home Assistant / smart-home ecosystem bridging
...
- We now reorder the post-M7 roadmap so bounded-growth and storage-hygiene hardening follows observation-driven idle intent sensing rather than product packaging: M8 formal terminal edge, M9 cloud-model-backed agent baseline, M10 model grounding/runtime memory, M11 terminal/CLI interaction maturity, M12 prompt/context engineering, M13 proposal-formation maturity, M14 model-provider connection reliability and diagnostics, M15 runtime-native credential/runtime-config baseline, M16 post-action deliberation/action loop, M17 multi-edge interaction expansion, M18 observation-driven idle intent sensing, M19 bounded-growth/storage-hygiene hardening, M20 Agent Harness and runtime action-loop architecture refactor with unified action/tool governance, M21 policy learning/review, M22 first packaged three-end product slice, and M23 Home Assistant / smart-home ecosystem bridge
- We now intentionally move bounded-growth and storage-hygiene hardening to M19, after observation-driven intent sensing has created realistic state/history growth pressure but before the harness refactor, policy learning, product packaging, and ecosystem bridge work build on larger runtime histories
