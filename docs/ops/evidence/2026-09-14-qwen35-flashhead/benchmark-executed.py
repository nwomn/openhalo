...
def main():
    ...
    import torch
    llm_args = dict(model="/work/assets/runtime-model", dtype="bfloat16", max_model_len=args.max_model_len,
    ...
    config = dict(model="embedl/Qwen3.5-0.8B-FlashHead",
                  revision="6208c90544971d154eefc047e6f84d05326fa031", clip=str(clip),
