...
REVISION = "9a5b623a83feae6a6b2ecad7a843334ccc119ce1"
...
def main():
    ...
    for repo, folder, revision in [
        ...
        ("openai/clip-vit-large-patch14-336", "clip", "ce19dc912ca5cd21c8a653c79e251e808ccabcd1"),
    ]:
        ...
        for entry in meta["siblings"]:
            ...
            wanted = (name.endswith((".json", ".txt", ".bin", ".model"))
